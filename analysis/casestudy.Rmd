...
interestGenes.ns.cancer <-
  interestGenes.ns[interestGenes.ns %in% 
                     GK$GeneID[GK$PathwayID %in% c('path:hsa05223','path:hsa05200')]]
...
interestGenes.s.cancer <-
  interestGenes.s[interestGenes.s %in% GK$GeneID[GK$PathwayID %in% c('path:hsa05223','path:hsa05200')]]
...
plot.heat.s <-
  wrap_elements(grid.grabExpr(draw(foo.heat(cpm.scaled.s))))
